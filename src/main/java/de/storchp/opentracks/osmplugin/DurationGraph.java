...
public class DurationGraph extends MapsActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (size) {
            case 3 -> { //seasons
                ...
                while (start.isBefore(end)) {
                    ...
                    if (start.isBefore(startSummer)) {
                        barHeight[0] += data.duration;
                    } else if (start.isBefore(startFall)) {
                        barHeight[1] += data.duration;
                    } else if (start.isBefore(startWinter)) {
                        barHeight[2] += data.duration;
                    }
                    start.plusDays(1);
                }
            ...
            case 7 -> { //week
                ...
                while (weekStart.isBefore(weekEnd)) {
                    ...
                    barHeight[dayOfWeekIndex] += data.duration;
        ...
        BarDataSet dataSet = new BarDataSet(entries, "Duration Distribution");
