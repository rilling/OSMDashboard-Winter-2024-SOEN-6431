...
public class RunsGraph extends MapsActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.runsgraph);
        ...
        switch (size) {
            ...
            case 7 -> { //week
                ...
                while (weekStart.isBefore(weekEnd)) {
                    ...
                    barHeight[dayOfWeekIndex] += data.runs;
        ...
        BarDataSet dataSet = new BarDataSet(entries, "Runs Distribution");
